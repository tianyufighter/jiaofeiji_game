...
class BattleP4(pygame.sprite.Sprite):
    """
    战斗的敌人
    """
    # 加载死亡行为
    die = role.DirAction("di5\\die", "1673-ac48c200-", 4, 8, False)
    # 加载战斗行为
    fight = role.DirAction("di5\\fight", "1506-98d7f621-", 4, 10, False)
    # 站立行为
    station = role.DirAction("di5\\station", "1684-adb19915-", 4, 2, False)
    # 逃跑
