...
from dialog.huanggong.shi_dialog import ShiDialog
from role import DirAction


class Zhan12(pygame.sprite.Sprite):
    """
    士兵
    """
    def __init__(self, x, y):
        self.walk = DirAction("zhan2", "1501-98071cdb-", 4, 8, True)
        self.pos_x = x
        self.pos_y = y
        self.width = 156
        self.height = 153
