...
from dialog.wuzhuangguan.fang_dialog import FangDialog
from role import DirAction


class Fang(pygame.sprite.Sprite):
    """
    皇上
    """
    def __init__(self, x, y):
        self.walk = DirAction("heshang4", "1618-a6169d14-", 4, 11, True)
        self.pos_x = x
        self.pos_y = y
        self.width = 58
        self.height = 90
