...
class BattleDi(pygame.sprite.Sprite):
    """
    战斗的敌人
    """
    # 加载死亡行为
    die = role.DirAction("di1\\die", "1675-ac6d8056-", 4, 8, False)
    # 加载战斗行为
    fight = role.DirAction("di1\\fight", "2293-f26d871d-", 4, 14, False)
    # 站立行为
    station = role.DirAction("di1\\station", "0831-53bf0175-", 4, 12, False)
    # 逃跑
    ...
    def attack_hp(self, hp):
        ...
        if self.hp <= 10:
            self.set_status(DiBattleStatus.Escape)
