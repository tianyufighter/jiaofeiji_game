...
class BattleP3(pygame.sprite.Sprite):
    """
    战斗的敌人
    """
    # 加载死亡行为
    die = role.DirAction("di4\\die", "0912-5a9bf84e-", 4, 10, False)
    # 加载战斗行为
    fight = role.DirAction("di4\\fight", "0577-388a4093-", 4, 17, False)
    # 站立行为
    station = role.DirAction("di4\\station", "2007-d0c5ffc8-", 4, 2, False)
    # 逃跑
