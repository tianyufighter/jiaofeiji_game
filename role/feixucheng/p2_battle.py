...
class BattleP2(pygame.sprite.Sprite):
    """
    战斗的敌人
    """
    # 加载死亡行为
    die = role.DirAction("di3\\die", "0063-6f06887-", 4, 10, False)
    # 加载战斗行为
    fight = role.DirAction("di3\\fight", "2348-f704761a-", 4, 13, False)
    # 站立行为
    station = role.DirAction("di3\\station", "1642-a82a5097-", 4, 12, False)
    # 逃跑
